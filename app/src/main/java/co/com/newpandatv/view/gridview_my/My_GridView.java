...
//                mVibrator.vibrate(50);//设置震动时间
                ...
                if (dragView == null) {
                    ...
                    TextView tv_text = (TextView) dragView.findViewById(R.id.gridview_item_content);
                    tv_text.setText(((TextView) view.findViewById(R.id.gridview_item_content)).getText());
                } else {
                    TextView tv_text = (TextView) dragView.findViewById(R.id.gridview_item_content);
                    tv_text.setText(((TextView) dragView.findViewById(R.id.gridview_item_content)).getText());
                }
    ...
    private void closeWindow(MotionEvent ev) {
        ...
        ((GridView_Adapter) getAdapter()).notifyDataSetChanged();
    }
    ...
    private void updateWindow(MotionEvent ev, int deltaX, int deltaY) {
        ...
        if (mTempPos != AdapterView.INVALID_POSITION && mTempPos != prePos) {
            ...
            ((GridView_Adapter) getAdapter()).swap(prePos, mTempPos);
            prePos = mTempPos;
        }
